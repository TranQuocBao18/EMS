...
namespace EMS.Web.Components.Pages.Liquidation.LiquidationRequest.Update
{
	public partial class ApproveRequestLv2
	{
		...
		public async Task Submit()
		{
			...
			var res = await ApiClient.PostAsync<BaseResponseModel, ApproveRequestDto>($"/api/LiquidationRequest/lv2/approve", Model);
			if (res != null && res.Success)
			{
				ToastService.ShowSuccess("Duyệt yêu cầu thành công!");
				NavigationManager.NavigateTo("/liquidation/requestlv1");
			}
		}
	}
}
