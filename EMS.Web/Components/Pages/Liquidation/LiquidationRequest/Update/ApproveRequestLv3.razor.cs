...
namespace EMS.Web.Components.Pages.Liquidation.LiquidationRequest.Update
{
	public partial class ApproveRequestLv3
	{
		...
		public async Task Submit()
		{
			...
			var res = await ApiClient.PostAsync<BaseResponseModel, ApproveRequestDto>($"/api/LiquidationRequest/lv3/approve", Model);
			if (res != null && res.Success)
			{
				ToastService.ShowSuccess("Duyệt yêu cầu thành công!");
				NavigationManager.NavigateTo("/liquidation/requestlv2");
			}
		}
	}
}
