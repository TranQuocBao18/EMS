...
namespace EMS.Web.Components.Pages.Maintenance.MaintenanceRequest.Update
{
	public partial class ApproveRequestLv2
	{
		...
		public async Task Submit()
		{
			...
			var res = await ApiClient.PostAsync<BaseResponseModel, ApproveRequestDto>($"/api/MaintenanceRequest/lv2/approve", Model);
			if (res != null && res.Success)
			{
				ToastService.ShowSuccess("Duyệt yêu cầu thành công!");
				NavigationManager.NavigateTo("/maintenance/requestlv1");
			}
		}
	}
}
