...
namespace EMS.Web.Components.Pages.Maintenance.MaintenanceRequest.Create
{
	public partial class CreateMaintenanceRequest
	{
		...
		public async Task Submit()
		{
			...
			var res = await ApiClient.PostAsync<BaseResponseModel, MaintenanceRequestModel>("/api/MaintenanceRequest/create", Model);
